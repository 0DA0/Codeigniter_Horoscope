...
.burclar-dunyasi {
    ...
    <!-- Menü Barı -->
    <nav class="menu">  
        <div class="menu-item"><a href="<?= base_url('Anasayfa')?>">Ana Sayfa</a></div>
        <div class="menu-item"><a href="<?= base_url('GunlukBurcYorumu')?>">Günlük Burç Yorumları</a></div>
        <div class="menu-item"><a href="<?= base_url('BurçHesaplama')?>">Burç Hesaplama</a></div>
        <div class="menu-item"><a href="<?= base_url('YükselenHesaplama')?>">Yükselen Burç Hesaplama</a></div>
        <?php
        if(isset($durum) && $durum)
        {
        ?>
        <div class="menu-item"><a href="<?= base_url('logout')?>" class="admin-giris">Admin Çıkışı</a></div>
        <?php
        }
        else
        {
        ?>    
        <div class="menu-item"><a href="<?= base_url('login')?>" class="admin-giris">Admin Girişi</a></div>
        <?php
        }
        ?>        
    </nav>
